...
blocked/partial issue by name so the user can triage them. Do not push, open PRs, or
merge anything — that decision is the user's.
...
- No auto-push, no auto-PR, no auto-merge — always a human decision.
